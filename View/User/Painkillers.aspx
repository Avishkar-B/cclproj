<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Painkillers.aspx.cs" Inherits="WebApplication21.View.User.Painkillers" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
    <title>Pharmacy - Pain Killers</title>
      ...
      <div class="container">
        <div class="row">
          <div class="title-section text-center col-12">
            <h2 class="text-uppercase">Pain-Killers</h2>
          </div>
        </div>
