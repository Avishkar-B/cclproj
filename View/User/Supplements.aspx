<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplements.aspx.cs" Inherits="WebApplication21.View.User.Supplements" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Pharmacy - Supplements</title>
      ...
      <div class="container">
        <div class="row">
          <div class="title-section text-center col-12">
            <h2 class="text-uppercase">Supplements</h2>
          </div>
        </div>
