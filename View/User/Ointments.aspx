<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ointments.aspx.cs" Inherits="WebApplication21.View.User.Ointments" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Pharmacy - Ointments</title>
      ...
      <div class="container">
        <div class="row">
          <div class="title-section text-center col-12">
            <h2 class="text-uppercase">Gel &amp Ointments</h2>
          </div>
        </div>
